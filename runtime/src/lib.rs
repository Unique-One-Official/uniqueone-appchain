...
pub use frame_support::{
	...
	traits::{KeyOwnerProofSystem, Randomness, InstanceFilter, MaxEncodedLen, FindAuthor, OnUnbalanced, Imbalance, U128CurrencyToVote, LockIdentifier},
	weights::{
...
parameter_types! {
	pub const CandidacyBond: Balance = 100 * UNET;
