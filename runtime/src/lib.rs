...
pub use frame_support::{
	...
	traits::{KeyOwnerProofSystem, Randomness, InstanceFilter, MaxEncodedLen},
	weights::{
...
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd, codec::Encode, codec::Decode, RuntimeDebug, MaxEncodedLen)]
pub enum ProxyType {
	Any,
	CancelProxy,
	Governance,
