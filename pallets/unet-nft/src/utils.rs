...
// 		add_category::<Runtime>();
// 		assert_ok!(UnetNft::<<Runtime as frame_system::Config>::AccountId, ClassId, TokenId>::create_class(
// 			&who,
// 			Vec::from("1"),
// 			Vec::from("1"),
// 			Vec::from("1"),
...
// 		Runtime: crate::Config,
// 	{
// 		assert_ok!(UnetNft::<<Runtime as frame_system::Config>::AccountId, ClassId, TokenId>::proxy_mint(
// 			&who,
// 			&to,
// 			class_id,
// 			Vec::from("1"),
...
// 	}
//
// 	pub fn peek_next_class_id<Runtime: Config + unet_traits::UnetNft<AccountId, ClassId, TokenId>>() -> Runtime::ClassId {
// 		Runtime::peek_next_class_id()
// 	}
// }
